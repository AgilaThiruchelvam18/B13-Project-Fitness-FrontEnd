    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <p className="mt-4 text-center">
          Forgot your password? <Link to="/customer/forgot-password" className="text-blue-500">Reset here</Link>
        </p>
        <p className="mt-4 text-center">
         Want To Register? <Link to="/customer/signup" className="text-blue-500">SignUp</Link>
        </p>
      </div>
    </div>
  );
